    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="glass-panel border border-white/5 rounded-xl p-8 text-center py-20 relative overflow-hidden">
                ...
                <h3 className="text-white font-bold text-xl mb-2 relative z-10">Settings Coming Soon</h3>
                <p className="text-gray-400 max-w-sm mx-auto relative z-10">We are building advanced configuration options for your analyses.</p>
            </div>
        </div>
    );
}
