    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-surface-card border border-border-subtle rounded-xl p-8 text-center py-20">
                ...
                <h3 className="text-white font-bold text-lg mb-2">Settings Coming Soon</h3>
                <p className="text-gray-400">We are building advanced configuration options for your analyses.</p>
            </div>
        </div>
    );
}
