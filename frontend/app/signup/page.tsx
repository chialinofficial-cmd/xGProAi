    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-[-10%] right-[-10%] w-[35%] h-[35%] bg-indigo-900/10 rounded-full blur-[100px]"></div>
            </div>
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                ...
                <div className="bg-surface-card border border-border-subtle rounded-2xl p-8 shadow-2xl">
                    ...
                    <p className="text-gray-400 text-center mb-8 text-sm">Join thousands of XAU/USD traders</p>
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-surface-card text-gray-500">Or sign up with</span>
                            </div>
                        </div>
